...
#line 23
sed -i -r "s/database/$MYSQL_DATABASE/1"   wordpress/wp-config.php
#line 26
sed -i -r "s/database_user/$MYSQL_USER:/1"  wordpress/wp-config.php
#line 29
sed -i -r "s/passwod/$MYSQL_PASSWORD/1"    wordpress/wp-config.php

# #line 32
sed -i -r "s/localhost/mariadb/1"    wordpress/wp-config.php
